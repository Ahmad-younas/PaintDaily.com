      ...
      <React.Fragment>
        ...
        <ErrorBoundary FallbackComponent={ErrorFallback}>
          <main className={Style.main}>
            ...
            <h2 className={Style.mid_text}>Explore By Category</h2>
            ...
            <Swiper
              ...
              <SwiperSlide className={Style.swiper_slide}><Link to="/Interior"><img className={Style.category_image} src={interior} /></Link></SwiperSlide>
              <SwiperSlide className={Style.swiper_slide}><Link to="/Exterior"><img className={Style.category_img} src={exterior} /></Link></SwiperSlide>
            ...
            <div className={Style.cat_header}>
              ...
              <h2 className={Style.most_selling_heading}>Interior Paint</h2>


              <div className={Style.view_btn1}>
                <Link style={{color: "white"}}  to='/Interior'>View All</Link>
              </div>
              ...
              className={Style.mySwiper}>
              {
                InteriorPaint.map((dta, index) => (
                  <SwiperSlide className={Style.swiper_slide} key={index}>
                    ...
                    <Link to={`/productPage/${dta.id}`} style={{textDecoration:"none"}}>
            ...
            <div className={Style.cat_header}>
              ...
              <div className={Style.view_btn2}>
                <Link style={{color: "white"}}  to='/Exterior' >View All</Link>
              </div>
            </div>
            ...
            <Swiper
              ...
              <SwiperSlide className={Style.swiper_slide}><img className={Style.category_image} src={bergerpaint} /></SwiperSlide>
              <SwiperSlide className={Style.swiper_slide}><img className={Style.category_img} src={diamondpaint} /></SwiperSlide>
            ...
            {/* Distemper paints */}
            <div className={Style.cat_header}>
              <h2 id="category" className={Style.most_selling_heading}>Distemper Paints</h2>
              <div className={Style.view_btn5}>
                <Link style={{color: "white"}} to='/Distemper'>View All</Link>
              </div>
            </div>
            <Swiper
              slidesPerView={4}
            ...
            <div className={Style.cat_header}>
              ...
              <div className={Style.view_btn5}>
                <Link style={{color: "white"}}  to='/Wallpaper'>View All</Link>
              </div>
            </div>
            <Swiper
              slidesPerView={4}
            ...
            <div className={Style.cat_header}>
              ...
              <div className={Style.view_btn5}>
                <Link style={{color: "white"}}  to='/BrushesRoller'>View All</Link>
              </div>
            </div>
            <Swiper
              slidesPerView={4}
