...
function Carts (props) {
   ...
   const StoreCart = () =>{
    ...
    return (
        ...
        <button className={Style.checkout_btn} onClick={StoreCart}>{id?<Link style={{color: 'white'}} to="/Checkout" >Check Out</Link>:<Link style={{color: 'white'}} to="/BuyerLogin" >Check Out</Link>}</button>
        </main>
