...
import {distemperPaint} from "../../../utils/categoryArray";
import {Link} from 'react-router-dom'
import Style from './distemper.module.css';
import distemperslider from "../../../../src/assets/Images/distemperslider.jpg";
...
const Distemper = () => {
    ...
    const Distemper = data.filter((dta)=>{
      ...
      const records = Distemper.slice(firstIndex,lastindex);
      const npage = Math.ceil(Distemper.length/recordsPerPage)
    ...
    return (
        <main>
            <Navbar/>
            <img className={Style.pimage} src={distemperslider}/>
            ...
            <h2 className={Style.pheading}>Distemper Paints</h2>
